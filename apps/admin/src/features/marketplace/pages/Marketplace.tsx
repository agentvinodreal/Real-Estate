...
import { Badge, Button, Card, CardGrid, Combobox, DetailModal, DetailRow, EmptyState, IconButton, Input, Label, LoadingState, Modal, PageHeader, Select, StatusToggle, Textarea } from '../../../shared/components/ui'
...
export default function Marketplace() {
  ...
  return (
    <div>
      ...
      <AnimatePresence>
        {showForm && (
          <Modal onClose={handleAddNewClick} className="max-h-[90vh] overflow-y-auto">
            <form onSubmit={handleSubmit} className="p-6">
              <div className="mb-6 flex items-start justify-between gap-4 border-b border-ink/5 pb-2">
                <h2 className="font-display text-lg font-bold text-ink">
                  {editId ? `Edit ${name}` : `Add New ${addLabel === 'Provider' ? 'Service Provider' : addLabel}`}
                </h2>
                <IconButton onClick={handleAddNewClick} aria-label="Close">
                      ...
                      <Card key={mat.id}>
                        <div>
                          ...
                          <img
                            ...
                            alt={mat.name}
                            className="mb-3 h-32 w-full border border-ink/5 object-cover"
                          />
                        ...
                        <div>
                          ...
                          <div className="mb-3 flex gap-3">
                            <img
                              ...
                              alt={sp.name}
                              className="h-12 w-12 rounded-full border border-ink/15 object-cover"
                            />
                            <div>
      ...
      <AnimatePresence>
        {viewMaterial && (
          <DetailModal
            ...
            imageUrl={cldAuto(viewMaterial.imageUrl || getMaterialImage(viewMaterial.category, viewMaterial.name))}
        ...
        {viewEquipment && (
          <DetailModal
            ...
            imageUrl={cldAuto(viewEquipment.imageUrl || getEquipmentImage(viewEquipment.name, viewEquipment.category))}
        ...
        {viewProvider && (
          <DetailModal
            ...
            imageUrl={cldAuto(viewProvider.profilePhotoUrl || getServicemanImage(viewProvider.role, viewProvider.name))}
